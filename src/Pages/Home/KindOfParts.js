  ...
  return (
    <div>
      <div class=" w-full h-3/5 p-5">
        <div>
          <h1 className="text-5xl font-bold my-14">ALL KINDS OF PARTS THAT YOU <br/>  NEED CAN FIND HERE</h1>
          <button className="btn bg-yellow-500 text-black my-4">Shop now </button>
        </div>
        <div class="w-full">
          <img
